...
function DetailsPage() {
  ...
  useEffect(() => {
    fetch("https://008f807c29681449.mokky.dev/movies/" + id)
      .then((res) => res.json())
      .then((json) => setData(json));
  }, []);
  return (
    <>
      <div className="detailspages container-xl top">
        {data && (
          <>
            <div className="detail-top">
              <div className="detail-title-img-box">
                <img src={data.titleImg} alt="" />
              </div>
              <div className="detail-name-box">
                <div className="type-box">
                  <div className="types">
                    <span>Blackhero</span>/<span>{data.type}</span>
                  </div>
                  <h4>{data.title}</h4>
                </div>
              </div>
            ...
            <div className="detail-bottom">
              <div className="detail-bottom-img-box">
                <img src={data.img} alt="" />
              </div>
              <div className="detail-bottom-text-box">
                <h4>Have You Seen Our Robot?</h4>
                <p>{data.text}</p>
